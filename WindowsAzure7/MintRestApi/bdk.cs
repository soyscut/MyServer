...
public partial class bdk : System.Web.Services.Protocols.SoapHttpClientProtocol {
    ...
    private AmbientContextSoapHeader ambientContextSoapHeaderValueField;
    ...
    private System.Threading.SendOrPostCallback GetSubscriptionsExOperationCompleted;
    ...
    public AmbientContextSoapHeader AmbientContextSoapHeaderValue {
        get {
            return this.ambientContextSoapHeaderValueField;
        }
        set {
            this.ambientContextSoapHeaderValueField = value;
        }
    }
    ...
    /// <remarks/>
    public event GetSubscriptionsExCompletedEventHandler GetSubscriptionsExCompleted;
    ...
    /// <remarks/>
    [System.Web.Services.Protocols.SoapHeaderAttribute("AmbientContextSoapHeaderValue", Direction=System.Web.Services.Protocols.SoapHeaderDirection.InOut)]
    ...
    [System.Web.Services.Protocols.SoapHeaderAttribute("UserContextualInfoSoapHeaderValue")]
    [System.Web.Services.Protocols.SoapHeaderAttribute("OnBehalfOfSoapHeaderValue")]
    [System.Web.Services.Protocols.SoapRpcMethodAttribute("http://tempuri.org/action/BDKServerObj2.GetSubscriptionsEx", RequestNamespace="http://tempuri.org/message/", ResponseNamespace="http://tempuri.org/message/")]
    public void GetSubscriptionsEx(int lDelegateIdHigh, int lDelegateIdLow, int lRequesterIdHigh, int lRequesterIdLow, string bstrObjectId, int lDetailLevel, out string pbstrErrorXML, out int plSubscriptionInfoCount, out string pbstrSubscriptionInfoSetXML) {
        object[] results = this.Invoke("GetSubscriptionsEx", new object[] {
                    lDelegateIdHigh,
                    lDelegateIdLow,
                    lRequesterIdHigh,
                    lRequesterIdLow,
    ...
    /// <remarks/>
    public System.IAsyncResult BeginGetSubscriptionsEx(int lDelegateIdHigh, int lDelegateIdLow, int lRequesterIdHigh, int lRequesterIdLow, string bstrObjectId, int lDetailLevel, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("GetSubscriptionsEx", new object[] {
                    lDelegateIdHigh,
                    lDelegateIdLow,
                    lRequesterIdHigh,
                    lRequesterIdLow,
                    bstrObjectId,
                    lDetailLevel}, callback, asyncState);
    }
    
    /// <remarks/>
    public void EndGetSubscriptionsEx(System.IAsyncResult asyncResult, out string pbstrErrorXML, out int plSubscriptionInfoCount, out string pbstrSubscriptionInfoSetXML) {
        object[] results = this.EndInvoke(asyncResult);
        pbstrErrorXML = ((string)(results[0]));
        plSubscriptionInfoCount = ((int)(results[1]));
        pbstrSubscriptionInfoSetXML = ((string)(results[2]));
    ...
    /// <remarks/>
    public void GetSubscriptionsExAsync(int lDelegateIdHigh, int lDelegateIdLow, int lRequesterIdHigh, int lRequesterIdLow, string bstrObjectId, int lDetailLevel) {
        this.GetSubscriptionsExAsync(lDelegateIdHigh, lDelegateIdLow, lRequesterIdHigh, lRequesterIdLow, bstrObjectId, lDetailLevel, null);
    }
    
    /// <remarks/>
    public void GetSubscriptionsExAsync(int lDelegateIdHigh, int lDelegateIdLow, int lRequesterIdHigh, int lRequesterIdLow, string bstrObjectId, int lDetailLevel, object userState) {
        if ((this.GetSubscriptionsExOperationCompleted == null)) {
            this.GetSubscriptionsExOperationCompleted = new System.Threading.SendOrPostCallback(this.OnGetSubscriptionsExOperationCompleted);
        }
        this.InvokeAsync("GetSubscriptionsEx", new object[] {
                    lDelegateIdHigh,
                    lDelegateIdLow,
                    lRequesterIdHigh,
                    lRequesterIdLow,
                    bstrObjectId,
                    lDetailLevel}, this.GetSubscriptionsExOperationCompleted, userState);
    }
    
    private void OnGetSubscriptionsExOperationCompleted(object arg) {
        if ((this.GetSubscriptionsExCompleted != null)) {
            System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
            this.GetSubscriptionsExCompleted(this, new GetSubscriptionsExCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
        }
    }
    ...
    /// <remarks/>
    public System.IAsyncResult BeginWriteOffBalance(int lDelegateIdHigh, int lDelegateIdLow, System.Guid trackingGuid, string bstrBalanceId, string bstrAccountId, string bstrCommentInfoXML, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("WriteOffBalance", new object[] {
                    lDelegateIdHigh,
                    lDelegateIdLow,
                    trackingGuid,
                    bstrBalanceId,
    ...
    /// <remarks/>
    public void EndWriteOffBalance(System.IAsyncResult asyncResult, out string transactionId) {
        object[] results = this.EndInvoke(asyncResult);
        transactionId = ((string)(results[0]));
    }
    ...
    /// <remarks/>
    public System.IAsyncResult BeginCreditPaymentInstrumentEx2(int lDelegateIdHigh, int lDelegateIdLow, string bstrTrackingGUID, string bstrPaymentInstrumentId, string bstrSkuReferenceXML, string bstrPropertyXML, int lFinancialReportingCode, string bstrAmount, bool fImmediatelySettle, string bstrCommentInfoXML, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("CreditPaymentInstrumentEx2", new object[] {
                    lDelegateIdHigh,
                    lDelegateIdLow,
                    bstrTrackingGUID,
                    bstrPaymentInstrumentId,
    ...
    /// <remarks/>
    public void EndCreditPaymentInstrumentEx2(System.IAsyncResult asyncResult, out string pbstrError) {
        object[] results = this.EndInvoke(asyncResult);
        pbstrError = ((string)(results[0]));
    }
    ...
    /// <remarks/>
    public System.IAsyncResult BeginCreditPaymentInstrumentEx3(
                int lDelegateIdHigh, 
                int lDelegateIdLow, 
                string bstrTrackingGUID, 
                string bstrPaymentInstrumentId, 
                string bstrSkuReferenceXML, 
                string bstrPropertyXML, 
                int lFinancialReportingCode, 
                string bstrAmount, 
                string currency, 
                bool fImmediatelySettle, 
                string bstrCommentInfoXML, 
                string bstrStoredValueLotExpirationDate, 
                string bstrStoredValueLotType, 
                string bstrStoredValueSku, 
                System.AsyncCallback callback, 
                object asyncState) {
        return this.BeginInvoke("CreditPaymentInstrumentEx3", new object[] {
                    lDelegateIdHigh,
                    lDelegateIdLow,
                    bstrTrackingGUID,
                    bstrPaymentInstrumentId,
                    ...
                    bstrStoredValueLotExpirationDate,
                    bstrStoredValueLotType,
                    bstrStoredValueSku}, callback, asyncState);
    }
    
    /// <remarks/>
    public void EndCreditPaymentInstrumentEx3(System.IAsyncResult asyncResult, out string pbstrError) {
        object[] results = this.EndInvoke(asyncResult);
        pbstrError = ((string)(results[0]));
    }
    ...
    /// <remarks/>
    public System.IAsyncResult BeginGetAccountIdFromAdminPUIDEx(int lDelegateIdHigh, int lDelegateIdLow, int lSearchPUIDHigh, int lSearchPUIDLow, bool fFullData, int lMax, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("GetAccountIdFromAdminPUIDEx", new object[] {
                    lDelegateIdHigh,
                    lDelegateIdLow,
                    lSearchPUIDHigh,
                    lSearchPUIDLow,
    ...
    /// <remarks/>
    public void EndGetAccountIdFromAdminPUIDEx(System.IAsyncResult asyncResult, out string pbstrErrorXML, out int pfMoreRows, out int plAccountInfoCount, out string pbstrAccountInfoSetXML) {
        object[] results = this.EndInvoke(asyncResult);
        pbstrErrorXML = ((string)(results[0]));
        pfMoreRows = ((int)(results[1]));
        plAccountInfoCount = ((int)(results[2]));
    ...
    /// <remarks/>
    public System.IAsyncResult BeginGetPaymentInstrumentsEx2(int lDelegateIdHigh, int lDelegateIdLow, int lRequesterIdHigh, int lRequesterIdLow, string bstrObjectId, string bstrPaymentInstrumentPropertySet, bool fReturnRemoved, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("GetPaymentInstrumentsEx2", new object[] {
                    lDelegateIdHigh,
                    lDelegateIdLow,
                    lRequesterIdHigh,
                    lRequesterIdLow,
    ...
    /// <remarks/>
    public void EndGetPaymentInstrumentsEx2(System.IAsyncResult asyncResult, out string pbstrErrorXML, out int plPaymentInstrumentInfoCount, out string pbstrPaymentInstrumentInfoSetXML) {
        object[] results = this.EndInvoke(asyncResult);
        pbstrErrorXML = ((string)(results[0]));
        plPaymentInstrumentInfoCount = ((int)(results[1]));
        pbstrPaymentInstrumentInfoSetXML = ((string)(results[2]));
    ...
    /// <remarks/>
    public System.IAsyncResult BeginGetStoredValueTransactions(int delegateIdHigh, int delegateIdLow, int requesterIdHigh, int requesterIdLow, string accountId, uint beginBillingPeriodId, uint endBillingPeriodId, byte returnTransactionsSet, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("GetStoredValueTransactions", new object[] {
                    delegateIdHigh,
                    delegateIdLow,
                    requesterIdHigh,
                    requesterIdLow,
                    ...
                    beginBillingPeriodId,
                    endBillingPeriodId,
                    returnTransactionsSet}, callback, asyncState);
    }
    
    /// <remarks/>
    public void EndGetStoredValueTransactions(System.IAsyncResult asyncResult, out string errorXml, out string storedValueTransactionSetXML) {
        object[] results = this.EndInvoke(asyncResult);
        errorXml = ((string)(results[0]));
        storedValueTransactionSetXML = ((string)(results[1]));
    }
...
[System.ComponentModel.DesignerCategoryAttribute("code")]
[System.Xml.Serialization.SoapTypeAttribute(Namespace="http://tempuri.org/")]
public partial class AmbientContextSoapHeader : SoapHeader {
...
/// <remarks/>
[System.CodeDom.Compiler.GeneratedCodeAttribute("wsdl", "4.0.30319.1")]
public delegate void GetSubscriptionsExCompletedEventHandler(object sender, GetSubscriptionsExCompletedEventArgs e);

/// <remarks/>
[System.CodeDom.Compiler.GeneratedCodeAttribute("wsdl", "4.0.30319.1")]
[System.Diagnostics.DebuggerStepThroughAttribute()]
[System.ComponentModel.DesignerCategoryAttribute("code")]
public partial class GetSubscriptionsExCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
    
    private object[] results;
    
    internal GetSubscriptionsExCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
            base(exception, cancelled, userState) {
        this.results = results;
    }
